...
Coursera Advanced Algorithms and Complexity wk04-02
... and this one "with a little help of my friends"
*/
...
int MaxWeightIndependentTreeSubset(const Graph& tree) noexcept
{
    size_t size = tree.size();
    if (size == 0)
        return 0;
