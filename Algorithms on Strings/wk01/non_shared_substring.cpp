...
Output Format.
The shortest (non-empty) substring of Text1 that does not appear in Text2. (Multiple
solutions may exist, in which case you may return any one.)
*/

// Branko Milosevic 2020-09-30
// Coursera Algorithms on Strings wk01-05
...
struct Node {
	Node () :
		...
		prev(-1)
	{
		for (int i = 0; i < LETTERS_NUM; i++) next[i] = -1;
	}
